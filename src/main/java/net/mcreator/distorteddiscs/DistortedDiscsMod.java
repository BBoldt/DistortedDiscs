...
@Mod("distorted_discs")
public class DistortedDiscsMod {
	public static final Logger LOGGER = LogManager.getLogger(DistortedDiscsMod.class);
	...
	public DistortedDiscsMod() {
		DistortedDiscsModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		DistortedDiscsModItems.REGISTRY.register(bus);
